...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   algoritm_step_counter.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pskip <pskip@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/11 18:40:25 by pskip             #+#    #+#             */
/*   Updated: 2022/03/01 18:15:59 by pskip            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// подсчет наименьшего количества шагов,
	// необходимых для переброски каждого элемента из стака b в a так,
	// что бы стэк а остался отсоритрованным
	// возвращает указатель на элемент с наименьшим значением шагов 
	t_stack	*on_count;
	t_stack	*for_push;
